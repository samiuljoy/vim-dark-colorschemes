...
hi! ColorColumn cterm=NONE ctermbg=0 guibg=#000000
hi! CursorColumn cterm=NONE ctermbg=0 guibg=#000000
hi! CursorLine cterm=NONE ctermbg=235 guibg=#13131c
hi! Comment ctermfg=242 guifg=#8489a7
...
hi! Error ctermbg=234 ctermfg=203 guibg=#000000 guifg=#a85858
hi! ErrorMsg ctermbg=234 ctermfg=203 guibg=#000000 guifg=#a85858
hi! WarningMsg ctermbg=234 ctermfg=203 guibg=#000000 guifg=#a85858
hi! EndOfBuffer ctermbg=234 ctermfg=236 guibg=#000000 guifg=#242940
hi! NonText ctermbg=234 ctermfg=236 guibg=#000000 guifg=#242940
hi! SpecialKey ctermbg=234 ctermfg=236 guibg=#000000 guifg=#242940
...
hi! LineNr ctermbg=235 ctermfg=0 guibg=#000000 guifg=#444b71
hi! MatchParen ctermbg=237 ctermfg=255 guibg=#3e445e guifg=#ffffff
hi! MoreMsg ctermfg=150 guifg=#9ec46d
...
hi! PreProc ctermfg=150 guifg=#9ec46d
hi! Question ctermfg=150 guifg=#9ec46d
hi! QuickFixLine ctermbg=236 ctermfg=252 guibg=#272c42 guifg=#c6c8d1
hi! Search ctermbg=216 ctermfg=234 guibg=#778899 guifg=#000000
hi! SignColumn ctermbg=235 ctermfg=239 guibg=#1e2132 guifg=#444b71
hi! Special ctermfg=150 guifg=#9ec46d
hi! SpellBad ctermbg=95 ctermfg=252 gui=undercurl guisp=#a85858
...
hi! TermCursorNC ctermbg=242 ctermfg=234 guibg=#8489a7 guifg=#161821
hi! Title ctermfg=216 gui=NONE guifg=#a77b5c
hi! Todo ctermbg=234 ctermfg=150 guibg=#45493e guifg=#9ec46d
...
hi! diffAdded ctermfg=150 guifg=#9ec46d
hi! diffRemoved ctermfg=203 guifg=#a85858
hi! ALEErrorSign ctermbg=235 ctermfg=203 guibg=#1e2132 guifg=#a85858
hi! ALEWarningSign ctermbg=235 ctermfg=216 guibg=#1e2132 guifg=#a77b5c
hi! ALEVirtualTextError ctermfg=203 guifg=#a85858
hi! ALEVirtualTextWarning ctermfg=216 guifg=#a77b5c
hi! CtrlPMode1 ctermbg=236 ctermfg=242 guibg=#2e313f guifg=#8489a7
hi! EasyMotionShade ctermfg=239 guifg=#3d425b
hi! EasyMotionTarget ctermfg=150 guifg=#9ec46d
hi! EasyMotionTarget2First ctermfg=216 guifg=#a77b5c
hi! EasyMotionTarget2Second ctermfg=216 guifg=#a77b5c
hi! GitGutterAdd ctermbg=235 ctermfg=150 guibg=#1e2132 guifg=#9ec46d
...
hi! GitGutterDelete ctermbg=235 ctermfg=203 guibg=#1e2132 guifg=#a85858
...
hi! SneakScope ctermbg=236 ctermfg=242 guibg=#272c42 guifg=#8489a7
hi! SyntasticErrorSign ctermbg=235 ctermfg=203 guibg=#1e2132 guifg=#a85858
hi! SyntasticStyleErrorSign ctermbg=235 ctermfg=203 guibg=#1e2132 guifg=#a85858
hi! SyntasticStyleWarningSign ctermbg=235 ctermfg=216 guibg=#1e2132 guifg=#a77b5c
hi! SyntasticWarningSign ctermbg=235 ctermfg=216 guibg=#1e2132 guifg=#a77b5c
hi! ZenSpace ctermbg=203 guibg=#a85858
hi! icebergALAccentRed ctermfg=203 guifg=#a85858
...
if has('nvim')
  ...
  let g:terminal_color_1 = '#a85858'
  let g:terminal_color_2 = '#9ec46d'
  let g:terminal_color_3 = '#a77b5c'
  let g:terminal_color_4 = '#84a0c6'
  let g:terminal_color_5 = '#a093c7'
  let g:terminal_color_6 = '#89b8c2'
  let g:terminal_color_7 = '#c6c8d1'
  let g:terminal_color_8 = '#8489a7'
  let g:terminal_color_9 = '#c97676'
  let g:terminal_color_10 = '#c0ca8e'
  let g:terminal_color_11 = '#c19271'
  let g:terminal_color_12 = '#91acd1'
  let g:terminal_color_13 = '#ada0d3'
  let g:terminal_color_14 = '#95c4ce'
  let g:terminal_color_15 = '#d2d4de'
else
  let g:terminal_ansi_colors = ['#1e2132', '#a85858', '#9ec46d', '#a77b5c', '#84a0c6', '#a093c7', '#89b8c2', '#c6c8d1', '#8489a7', '#c97676', '#c0ca8e', '#c19271', '#91acd1', '#ada0d3', '#95c4ce', '#d2d4de']
endif
